 ...
 * @version 1.0
 */
public class SDesignBackground extends VolatileImagePanel {
	/** Reference to the logging category */
	private static final Category cat = Category.getInstance(SDesignBackground.class.getName());
	 ...
	 */
	public SDesignBackground() {
		// Get the background tile
		Image tile = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("backdropdesign.png"));
		// Load the images
