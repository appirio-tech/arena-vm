...
public class TextUpdateRequest extends ContestMonitorRequest implements ProcessedAtBackEndRequest {
    ...
    public TextUpdateRequest(String tableName, String columnName, String whereClause, Object updateObject, boolean requireUniqueRow) {
