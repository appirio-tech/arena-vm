 ...
 * <ol>
 * <li>Added INSTANT_MATCHES_ROUND_TYPE_ID in  {@link #addRound(RoundData)}  method.</li>
 * <li>Added INSTANT_MATCHES_ROUND_TYPE_ID in {@link #removeRound(RoundData roundData)}  method.</li>
 * </ol>
 * </p>
 *
 * @author Michael Cervantes (emcee), savon_cn, xjtufreeman
 */
    ...
    */
    ...
    private synchronized void addRound(RoundData roundData) {
        ...
        if (!activeRoundsMap.containsKey(key)) {
            ...
            case ContestConstants.INSTANT_MATCHES_ROUND_TYPE_ID:
