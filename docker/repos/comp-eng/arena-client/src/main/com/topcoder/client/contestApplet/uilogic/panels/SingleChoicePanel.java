...
public class SingleChoicePanel implements QuestionPanel {
    ...
    public SingleChoicePanel(ContestApplet ca, String title, Question question) {
        this.question = question;
        page = ca.getCurrentUIManager().getUIPage("single_choice_panel", true);
        ...
        for (int i = 0; i < answers.size(); i++) {
            JRadioButton jrb1 = (JRadioButton) template.performAction("clone");
