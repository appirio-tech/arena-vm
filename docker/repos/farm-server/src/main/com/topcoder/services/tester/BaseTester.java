...
public abstract class BaseTester {
    private static final Logger log = Logger.getLogger(BaseTester.class);
    /**
     * <p>
     ...
     * @since 1.1
     */
    public static final int DEFAULT_EXTRA_EXECUTION_TIME;

    static {
    	ProcessorConfig config = ApplicationContextProvider.getContext().getBean(ProcessorConfig.class);
    	
    	DEFAULT_EXTRA_EXECUTION_TIME = config.getDefaultExtraExecutionTime();
    }
