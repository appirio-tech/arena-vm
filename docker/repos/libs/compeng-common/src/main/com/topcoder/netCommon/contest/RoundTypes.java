/*
 * Copyright (C) 2008-2015 TopCoder Inc., All Rights Reserved.
 */
 ...
 *
 * <p>
 * Changes in 1.1(TopCoder Competition Engine - Support Instant Match Type):
 * <ol>
 * <li>Added INSTANT_MATCHES_ROUND_TYPE_ID</li>
 * </ol>
 * </p>
 * @author Diego Belfer (mural), xjtufreeman, TCSASSEMBLER
 * @version 1.1
 */
public interface RoundTypes {    
    ...
    /** Represents a Instant Matches round. */
    public static final int  INSTANT_MATCHES_ROUND_TYPE_ID = 24;
