 ...
 * @author mitalub
 */
public class MainTeamProblemMoveResponse extends MoveResponse {

    public MainTeamProblemMoveResponse() {
    ...
    public String toString() {
        return "MainTeamProblemMoveResponse[<" + problems.size() + " problems>]";
    }
