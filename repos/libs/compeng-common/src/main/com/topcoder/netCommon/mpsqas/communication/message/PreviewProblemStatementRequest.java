 ...
 * @author mitalub
 */
public class PreviewProblemStatementRequest
        extends Message {
    ...
    public PreviewProblemStatementRequest() {
    }

    public PreviewProblemStatementRequest(ProblemComponent component) {
        type = MessageConstants.COMPONENT_STATEMENT;
        this.component = component;
    }

    public PreviewProblemStatementRequest(Problem problem) {
