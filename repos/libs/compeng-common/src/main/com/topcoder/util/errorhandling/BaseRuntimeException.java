 ...
 * <code>RuntimeException</code> classes in an application. It provides extended
...
public class BaseRuntimeException extends RuntimeException {
    ...
    /**
     * Constructs a new <code>BaseRuntimeException</code>.
     */
    public BaseRuntimeException() {
    }

    /**
     * Constructs a new <code>BaseRuntimeException</code>, with the 
     * given message.
     *
    ...
    /**
     * Get the cause of this BaseRuntimeException.
     *
     * @return the <code>Throwable</code> cause of this exception, or
     ...
     *  as this instance; this can't be its own cause
    ...
    /**
     * Returns the message for this exception. This includes the message
     * for this exception and all associated causes, separated by the
    ...
    /**
     * Prints this exception's stack trace to the given
     ...
     * <p>
     * The stack trace consists of this exception's stack trace, plus
     * the stack traces of all causes, separated by the String
     * <code>"Caused by: "</code>.
     * <p>
     * An example of what might be written:<br />
     * <pre>
     * com.acme.MyException: Message one
