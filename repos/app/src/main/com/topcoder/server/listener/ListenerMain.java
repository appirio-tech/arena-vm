...
public final class ListenerMain {
    ...
    private static void start() throws IOException {
        ...
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("listener-applicationContext.xml");
        ...
        if (monitorPort > 0) {
            ...
            monitorListener = listenerFactory.createListener("0.0.0.0", monitorPort, monitorProcessor, new EmptyMonitor(), 0, 0, 0,
                    new MonitorCSHandlerFactory(), monitorAllowedIPs, true, 0, Integer.MAX_VALUE);
    ...
    private static ListenerInterface buildListener(MonitorInterface monitorDataHandler) {
        ...
        String listenAddress = System.getProperty("arena.listen-bind-address", "0.0.0.0");
    	cat.info("Binding to address " + listenAddress);
        ...
        if (ListenerProperties.useHTTPTunnel()) {
        	...
        	// 0.0.0.0 is the wildcard address and will listen on all interfaces
    ...
    public static void main(String[] argv) {
        ...
        try {
        	...
        	cat.error("Could not start the listener: " + e.getMessage(), e);
            error(e);
