...
public class NodeSearch {
    ...
    public void findAllElementPartialMatchNode(Node node, String name, Hashtable attributes) //vector will contain attribute in even position and values in odd position
    {
        String value;
        String key;
        String gotValue;
    ...
    public void findAllElementNode(Node node, String name, Hashtable attributes) //vector will contain attribute in even position and values in odd position
    {
        String value;
        String key;
        String gotValue;
