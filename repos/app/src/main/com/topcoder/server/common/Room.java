 ...
 *
 * <p>
 * Changes for version 1.1 (Web Socket Listener - Backend Logic Update To Generate and Return the image)
 * <ol>
 *     <li>Added {@link #getCodeImagesCacheKey(int)}</li>
 * </ol>
 * </p>
 *
 * @uthor Hao Kung, ahmed.seddiq
 * @version 1.1
 *
 */
public class Room implements Serializable {
    ...
    */
    ...
    /**
     * Gets the cache key used to cache the generated code images for this room.
     * @param id the room id
     * @return the cache key for code images.
     * @since 1.1
     */
    public static String getCodeImagesCacheKey(int id) {
        return "Code.Images." + getCacheKey(id);
    }
