 ...
 * Author: Hao Kung
 *
 * Description: This class will contain information about a user in the system
 */
...
public final class User implements Serializable, Comparable {
    ...
    public User(int id, String name, int languageID, Timestamp regDate, 
            ...
            int schoolViewable,String userStatus) {
        setID(id);
        m_userName = name;
    ...
    public String getCoderInfo() {
        ...
        retVal.append(StringUtil.padRight("User name: ", INFO_LABEL_LENGTH-1));
        ...
        for(Iterator i = m_ratings.iterator(); i.hasNext(); ) {
            ...
            retVal.append(StringUtil.padRight("\n" + desc + "Rated events: ", INFO_LABEL_LENGTH));
            retVal.append(r.getNumRatings());
         
            if (r.getLastRatedEvent() != null) {
                retVal.append(StringUtil.padRight("\n" + desc + "Last event: ", INFO_LABEL_LENGTH));
        ...
        if ( m_coderType.equals("Student") && m_school != null && !m_school.equals("") && m_schoolViewable != 0) {
