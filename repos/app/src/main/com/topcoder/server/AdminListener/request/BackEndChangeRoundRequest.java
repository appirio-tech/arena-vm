...
/**
 * This is a request to be sent to AdminServices bean to change to 
 * a new round.
 *
 ...
 */
public class BackEndChangeRoundRequest implements CustomSerializable, Serializable {
     ...
     * @param roundId
     */
    public BackEndChangeRoundRequest(int senderId, long userId, int roundId) {
    ...
    public BackEndChangeRoundRequest() {
