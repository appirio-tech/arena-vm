...
public class TextSearchRequest extends ContestMonitorRequest implements ProcessedAtBackEndRequest {
    ...
    public TextSearchRequest(String tableName, String columnName, String searchText, String whereClause) {
