...
public class ObjectSearchResponse implements CustomSerializable {
    ...
    public ObjectSearchResponse(boolean succeeded, String message, ResultSetContainer results) {
