...
import com.topcoder.server.ejb.TestServices.longtest.LongSubmitter;
...
public class LongContestServicesBean implements LongContestServices {
    ...
    /**
     * Test counter object used to detect the end of the test for a submssion
     */
        ...
        public void run() {
            try {
                ...
                for (int i = offset; i < len; i++) {
                    ...
                    longTesterInvoker.systemTestSubmission(id, componentFiles, testCaseIds, roundType, problemCustomSettings);
                }
                success = true;
            } catch (Exception e) {
    ...
    private LongSubmission compileLong(LongCompileRequest req) throws CompilationTimeoutException, LongContestServicesException {
        try {
            ...
            s_trace.warn("Compiler Timeout", e);
