 ...
 *
 * <p>
 * Changes in version 1.3 (TopCoder Competiton Engine - Automatically End Matches v1.0) :
 * <ol>
 *      <li>Update {@link #execSystemTest(int contestId, int roundId, int coderId,
 *           boolean reference, int[] componentIds)} method.</li>
 *      <li>Add {@link #execSystemTest(int contestId, int roundId, int coderId,
 *           boolean reference, int[] componentIds, boolean async)} method.</li>    
 *      <li>Add {@link #execSystemTest(boolean isPracticeSystemTest, int contestId, int roundId, int coderId,
            boolean reference, int[] componentIds, boolean async)} method.</li>     
 * </ol>
 * </p>
 * @author Diego Belfer (mural), gevak, dexy, TCSASSEMBLER
 * @version 1.3
 */
class SRMTestScheduler {
    ...
    /**
     * <p>Runs system test for the given round, components and coder.</p>
     *
    ...
    public static void execSystemTest(int contestId, int roundId, int coderId,
        ...
        execSystemTest(contestId, roundId, coderId, reference, componentIds, true);
    }
    /**
     * Runs system test for the given round, components and coder
     * @param contestId The contest id
     * @param roundId The round id.
     * @param coderId The coder id, 0 all coders
     * @param reference If the test should be run in exclusive mode
     ...
     */
    public static void execSystemTest(int contestId, int roundId, int coderId,
            boolean reference, int[] componentIds, boolean async) throws SRMTestSchedulerStateException {
        ...
        execSystemTest(false, contestId, roundId, coderId, reference, componentIds, async);
    }
    ...
    public static void execPracticeSystemTest(int contestId, int roundId, int coderId, int[] componentIds) {
        execSystemTest(true, contestId, roundId, coderId, false, componentIds, true);
    }
    ...
    public static void cancelSystemTestCaseTesting(int contestId, int roundId, int testCaseId) throws SRMTestSchedulerStateException, Exception {
        ...
        if (srmTester.existsPendingSystemTestForRound(contestId, roundId)) {
    ...
    /**
     * Runs system test for the given round, components and coder.
     * @param isPracticeSystemTest if it is the practice system test.
     * @param contestId the contest id.
     * @param roundId the round id.
     * @param coderId the coder id.
    ...
    private static void execSystemTest(boolean isPracticeSystemTest, int contestId, int roundId, int coderId,
            boolean reference, int[] componentIds, boolean async) {
        ...
        if (async) {
            ...
            internalExecSystemTest(request);
        }
    }
