...
public class MPSQASListener {
    ...
    final static public int DEFAULT_PORT = 5037;
    ...
    public MPSQASListener(int port)
        ...
        listener = new NBIOListener("0.0.0.0", port, mpsqasProcessor,
                1, 1, 1, new MPSQASMonitor(),
                new MPSQASMessageHandlerFactory(), new HashSet(), false, 0, Integer.MAX_VALUE);
