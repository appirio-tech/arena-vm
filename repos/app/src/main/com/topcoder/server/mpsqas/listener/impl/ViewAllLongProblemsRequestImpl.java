...
/**
 * Handles a View All Long Problems Request by making sure the user is an admin and
 * then getting the problems from the bean.
 *
 * @author mitalub
 */
public class ViewAllLongProblemsRequestImpl
        extends ViewAllLongProblemsRequest
    ...
    public void enter(Peer peer) {
        ...
        try {
            problems = mpeer.getProblemServices().getLongProblems(
        ...
        MainLongProblemMoveResponse m = new MainLongProblemMoveResponse();
