 ...
 * @author mitalub
 */
public class ViewAllProblemsRequestImpl
        extends ViewAllProblemsRequest
    ...
    public void enter(Peer peer) {
        ...
        try {
            problems = mpeer.getProblemServices().getSingleProblems(
        ...
        MainProblemMoveResponse m = new MainProblemMoveResponse();
