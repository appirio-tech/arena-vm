 ...
 *  @version 1.8
 */
public class MPSQASFiles implements Serializable, CustomSerializable {
    ...
    /** The source files. */
    private Map sourceFiles = null;

    /** The class files. */
    private Map classFiles = null;
    ...
    private Map webServiceFiles = null;
     ...
     */
    public void setSourceFiles(Map sourceFiles) {
     ...
     */
    public void setClassFiles(Map classFiles) {
     ...
     */
    public void setWebServiceFiles(Map webServiceFiles) {
