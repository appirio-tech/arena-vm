/*
 * CalculateFinalSystemTestScores
 * 
 * Created Oct 8, 2007
 */
 ...
 * @version $Id: CalculateFinalSystemTestScores.java 65991 2007-10-10 18:38:28Z thefaxman $
 */
public class CalculateFinalSystemTestScores {
    static Logger s_trace = Logger.getLogger(CalculateFinalSystemTestScores.class);
    ...
    public static void main(String[] args) throws SQLException, RemoteException, LongContestServicesException, NamingException, CreateException {
        ...
        try {
            results = getLongTestResults(componentId, roundId, ServicesConstants.LONG_SYSTEM_TEST_ACTION, conn);
        ...
        LongContestServicesLocator.getService().updateLongSystemTestFinalScores(new LongRoundScores[] {newResults});
