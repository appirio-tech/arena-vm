...
public class HandleRenderer extends SEmbeddedPanel {
    ...
    /** The titles */
    //private static final String[] titles = {"HANDLE:", "TC RATING:", "TCS RATING:", "SEED:", "EARNINGS:"};
    private static final String[] titles = {"HANDLE:", "TC RATING:", "TCS RATING:", "EARNINGS:"};

    /** The descriptions */
    private String[] desc = new String[titles.length];

    /** The Colors for the descriptions */
    private static final Color[] descColor = {new Color(204, 0, 0), new Color(204, 0, 0), Color.white, Color.white, Color.white};

    /** Constructs the trailer panel */
    public HandleRenderer(String handle, int tcRating, int tcsRating, int seed, double earnings) {
        ...
        //desc[3] = String.valueOf(seed);
        desc[3] = "$" + frm.format(earnings);
