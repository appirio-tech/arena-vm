...
import com.topcoder.client.spectatorApp.widgets.SMargin;import com.topcoder.client.spectatorApp.widgets.SDevelopmentDividerLine;

import com.topcoder.client.spectatorApp.widgets.STextField;
import java.awt.Color;

public class DevelopmentHeaderPanel extends LayeredPanel implements AnimatePanel {
	 ...
	 */
	public DevelopmentHeaderPanel(String roomTitle) {
		SDevelopmentDividerLine dividerLine = new SDevelopmentDividerLine(true);
                SImage rightBackground = new SImage(Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("tourneyLogoDevelopment.png")));
	...
	public void setRoomTitle(String roomTitle) {
		...
		SDevelopmentDividerLine dividerLine = (SDevelopmentDividerLine) getLayer(DIVIDER_LAYER);
