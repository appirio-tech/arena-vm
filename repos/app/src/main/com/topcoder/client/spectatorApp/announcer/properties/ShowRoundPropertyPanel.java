 ...
 * @version 1.0
 */
public class ShowRoundPropertyPanel extends PropertyPanel {
	 ...
	 * @param event
	 */
	public ShowRoundPropertyPanel(ShowRoundEvent event) {
	...
	public void saveProperties() {
		...
		((ShowRoundEvent)getEvent()).setRoundID(((Integer)roundID.getValue()).intValue());
