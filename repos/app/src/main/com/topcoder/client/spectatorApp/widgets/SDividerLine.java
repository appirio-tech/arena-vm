 ...
 * @version 1.0
 */
public class SDividerLine extends VolatileImagePanel {
     ...
     * @param atTop
     */
	public SDividerLine(boolean atTop) {
		// Save the atTop value
		this.atTop = atTop;
		
		// Get the divider image
        Image divider = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("dividerline.jpg"));
