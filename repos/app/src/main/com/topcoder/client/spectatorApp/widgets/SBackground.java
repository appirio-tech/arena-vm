 ...
 * @version 1.0
 */
public class SBackground extends VolatileImagePanel {
	/** Reference to the logging category */
	private static final Category cat = Category.getInstance(SBackground.class.getName());
	...
	public SBackground() {
		...
		Image tile = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("dots.gif"));
		// Load the images
