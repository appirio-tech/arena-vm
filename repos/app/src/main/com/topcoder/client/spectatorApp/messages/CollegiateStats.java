...
public class CollegiateStats implements java.io.Serializable {
    ...
    /** Constructor */
    public CollegiateStats(int numCompetitions, int numSubmissions, double submissionPrct, int numChallenges, double challengePrct) {
    ...
    public String toString() {
        return new StringBuffer().append("(CollegiateStats)[").append(numCompetitions).append(", ").append(numSubmissions).append(", ").append(submissionPrct).append(", ").append(numChallenges).append(", ").append(challengePrct).append("]").toString();
    }
}
