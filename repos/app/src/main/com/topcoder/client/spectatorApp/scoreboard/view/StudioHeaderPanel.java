...
import com.topcoder.client.spectatorApp.widgets.SMargin;import com.topcoder.client.spectatorApp.widgets.SStudioDividerLine;

import com.topcoder.client.spectatorApp.widgets.STextField;
import java.awt.Color;

public class StudioHeaderPanel extends LayeredPanel implements AnimatePanel {
	 ...
	 */
	public StudioHeaderPanel(String roomTitle) {
		SStudioDividerLine dividerLine = new SStudioDividerLine(true);
	...
	public void setRoomTitle(String roomTitle) {
		...
		SStudioDividerLine dividerLine = (SStudioDividerLine) getLayer(DIVIDER_LAYER);
