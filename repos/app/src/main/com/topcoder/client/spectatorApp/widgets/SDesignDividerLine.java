...
public class SDesignDividerLine extends VolatileImagePanel {
	...
	public SDesignDividerLine(boolean atTop) {
        ...
        Image divider = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("headerBGDesign.png"));
