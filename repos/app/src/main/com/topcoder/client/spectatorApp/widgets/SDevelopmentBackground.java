 ...
 * @version 1.0
 */
public class SDevelopmentBackground extends VolatileImagePanel {
	/** Reference to the logging category */
	private static final Category cat = Category.getInstance(SDevelopmentBackground.class.getName());
	 ...
	 */
	public SDevelopmentBackground() {
		// Get the background tile
		Image tile = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("backdropdevelopment.png"));
		// Load the images
