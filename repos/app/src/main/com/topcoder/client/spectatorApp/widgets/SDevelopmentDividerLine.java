...
public class SDevelopmentDividerLine extends VolatileImagePanel {
	...
	public SDevelopmentDividerLine(boolean atTop) {
        ...
        Image divider = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("headerBGDevelopment.png"));
