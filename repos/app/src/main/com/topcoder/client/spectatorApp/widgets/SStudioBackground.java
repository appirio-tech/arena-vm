 ...
 * @version 1.0
 */
public class SStudioBackground extends VolatileImagePanel {
	/** Reference to the logging category */
	private static final Category cat = Category.getInstance(SStudioBackground.class.getName());
	 ...
	 */
	public SStudioBackground() {
		// Get the background tile
		Image tile = Toolkit.getDefaultToolkit().getImage(SpectatorApp.class.getResource("backdrop.png"));
		// Load the images
