 ...
 * @version 1.0
 */
public class ShowSystemTestResultsByCoderAllPanel extends PropertyPanel {
	 ...
	 * @param event
	 */
	public ShowSystemTestResultsByCoderAllPanel(ShowSystemTestResultsByCoderAllEvent event) {
	...
	public void saveProperties() {
		...
		((ShowSystemTestResultsByCoderAllEvent)getEvent()).setRoundID(((Integer)roundID.getValue()).intValue());
		((ShowSystemTestResultsByCoderAllEvent)getEvent()).setDelay(((Integer)delay.getValue()).intValue());
