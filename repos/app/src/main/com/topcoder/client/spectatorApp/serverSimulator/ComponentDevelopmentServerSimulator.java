...
public class ComponentDevelopmentServerSimulator extends Thread {
//	private static final Logger cat = Logger.getLogger(ComponentDevelopmentServerSimulator.class.getName());
//	
//	/** Port to listen on */
...
//	private final int ROUNDID = 5002;
...
//		new ComponentDevelopmentServerSimulator();
//	}
//	
//	public ComponentDevelopmentServerSimulator() {
...
//		};
//		
//		coders = new CoderData[] { new CoderData(1, "Pops", 1234),
//			                        new CoderData(2, "nicka81", 2391),		    
//			                        new CoderData(3, "adic", 2234),		    
//			                        new CoderData(4, "Thinman", 1929),		    
//			                        new CoderData(5, "kyky", 1892),		    
//			                        new CoderData(6, "AleaActaEst", 1999),		    
//			                        new CoderData(7, "aubergineanode", 2200),		    
//			                        new CoderData(8, "real_vg", 1000),		    
//		};
//		
//		reviewers = new CoderData[] { new CoderData(1001, "WishingBone", 2929),
//			                           new CoderData(1002, "askonov", 1818),
//			                           new CoderData(1003, "victor_lxd", 2222)
//		};
//		
...
//						} else {
//							cat.warn("Unknown appeal status: " + Arrays.toString(appeals[x][y]));
//							continue;
//						}
//						
