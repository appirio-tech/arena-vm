/*
 * Copyright (C) 2012 - 2015 TopCoder Inc., All Rights Reserved.
 *
 ...
 * <ol>
 * <li>Added <code>autoEnd</code> in the UI to indicate if the round is ended automatically.</li>
 * <li>Added <code>buildAutoEndDropDown()</code> method.</li>
 * <li>Updated <code>display(RoundData round, boolean committed)</code> to retrieve the autoEnd.</li>
 * <li>Updated <code>commit()</code> method to update autoEnd.</li>
 * <li>Updated <code>addItems()</code> method to add autoEnd.</li>
 * </ol>
 * </p>
 *
 ...
 * </p>
 *
 * @author  TCDEVELOPER, TCSASSEMBLER, dexy
 * @version 1.2
 * @since 1.0
 */
public class RoundFrame extends InputFrame {
    ...
    /**
     * Add the auto end JComboBox, it has "False" and "True". "True" is the first one, "False" is the second one.
     * @since 1.1
     */
    private JComboBox autoEnd = new JComboBox();

    /**
     * The editorial link JTextField. Can contain maximum 255 chars.
     * @since 1.2
     */
    private JTextField editorialLink = new JTextField(30);
    ...
    protected void addItems() {
        ...
        addItem("End Automatically", autoEnd);
        addItem("Editorial Link", editorialLink);
    ...
    /**
     * Build the auto end dropdown list.
     * @since 1.1
     */
    private void buildAutoEndDropDown() {
        autoEnd.removeAllItems();
        autoEnd.addItem("True");
        autoEnd.addItem("False");
        frame.repaint();
    }
     ...
     * Changes in 1.1:
     * <pre>
     * Add display for autoEnd.
     * </pre>
     * Changes in 1.2:
     * Add display for editorial link.
     */
    public void display(RoundData round, boolean committed) {
        ...
        buildInvitationDropDown();
        buildAutoEndDropDown();
        editorialLink.setText(round.getEditorialLink());
        ...
        autoEnd.setSelectedIndex(round.isAutoEnd() ? 0 : 1);
    ...
    private void commit() {
        final RoundData newRound = new RoundData(
                ...
                autoEnd.getSelectedIndex() == 0,
                editorialLink.getText()
        );
