...
public class TextSearchFrame extends JFrame implements ResponseCallback {

    private static final Logger log = Logger.getLogger(TextSearchFrame.class);
    ...
    public TextSearchFrame(MonitorFrame frame, CommandSender sender) {
        super("Text object search");
        this.frame = frame;
        this.sender = sender;
        setResizable(false);
    ...
    private void searchPressed() {
        ...
        sender.sendTextSearchRequest(tableName, columnName, searchText, whereClause);
        setVisible(false);
    }
    ...
    public void receivedResponse(Object response) {
        ...
        TextColumnResponse blobResponse = (TextColumnResponse) response;
