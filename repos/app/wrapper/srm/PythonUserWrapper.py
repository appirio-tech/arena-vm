...
"""
Wrapper for Python solution.

<p>
Changes in version 1.1 (TopCoder Competition Engine - Stack Size Configuration For SRM Problems v1.0):
<ol>
...
<p>
Changes in version 1.2 (TopCoder Competition Engine - char type support for Python v1.0):
<ol>
    <li>Added readChar(fd) in order to support read char type data.</li>
    <li>Added writeChar(fd) in order to support write char type data.</li>
</ol>
</p>

@author Selena, savon_cn
@version 1.2
"""
