rem The first parameter (%1) is the contest listener IP

set JAVACMD=%JAVA_HOME%/bin/java
set MAIN=com.topcoder.server.AdminListener.AdminListenerMain
set BASE=..
...
%JAVACMD% -cp %CP% -Dcom.topcoder.logging.id=AdminListener.5006 %MAIN% 5006 @arenaListernerAppHost@:@arenaListernerAppPort@ 5013
