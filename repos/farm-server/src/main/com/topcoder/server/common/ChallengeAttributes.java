...
public final class ChallengeAttributes
    ...
    private int componentMaxPointVal = 0;
    private String challengeHistoryMessage = null;
    ...
    public ChallengeAttributes(RoundComponent component, int language, Problem problem) {
        ...
        this.resultCode = 0;
        componentMaxPointVal = component.getPointVal();
    }
...
// set
    ...
    */
    ...
    public void setChallengeHistoryMessage(String msg) {
        challengeHistoryMessage = msg;
    }

    public String getChallengeHistoryMessage() {
        if (challengeHistoryMessage == null) {
        	// TODO: this logic shouldn't be in a data bean
            StringBuilder message = new StringBuilder(getChalUsername());
            ...
            if (isTeam) {
                ...
                message.append(componentMaxPointVal);
                message.append("-point problem.\n");
            }
            return message.toString();
        }
        return challengeHistoryMessage;
    }
    ...
    public void customReadObject(CSReader reader) throws IOException, ObjectStreamException {
        ...
        componentMaxPointVal = reader.readInt();
        challengeHistoryMessage = reader.readString();
    ...
    public void customWriteObject(CSWriter writer) throws IOException {
        ...
        writer.writeInt(componentMaxPointVal);
        writer.writeString(challengeHistoryMessage);
	...
	public int getComponentMaxPointVal() {
		return componentMaxPointVal;
	}

	public void setComponentMaxPointVal(int componentMaxPointVal) {
		this.componentMaxPointVal = componentMaxPointVal;
	}
