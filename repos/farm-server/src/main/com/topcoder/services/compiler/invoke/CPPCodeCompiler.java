...
public class CPPCodeCompiler implements CodeCompiler {
     ...
     * @since 1.4 
     */
    private static final String ALGO_CC_NO_THREADING_OPTIONS;

    /**
     * This constant defines name for CC no threading options property for MM.
     * @since 1.4 
     */
    private static final String LONG_CC_NO_THREADING_OPTIONS;
...
//    private static final String BUILD_COMMAND_THREADING  = INTEL_THREADING + CFLAGS_THREADING + " -o ";
    ...
    static {
    	...
    	ALGO_CC_NO_THREADING_OPTIONS = config.getMatchCppNoThreadingOptions();
    	LONG_CC_NO_THREADING_OPTIONS = config.getMarathonCppNoThreadingOptions();
    }
    ...
    private static String getCCNoThreadingOptions(int componentTypeId) {
        if (componentTypeId == ApplicationConstants.LONG_PROBLEM) {
            return LONG_CC_NO_THREADING_OPTIONS;
        } else {
            return ALGO_CC_NO_THREADING_OPTIONS;
        }
    }
