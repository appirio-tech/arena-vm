...
public final class HSRegistrantsTablePanel extends UserTablePanel {

    private JFrame jf = null;
    public JLabel totalLabel;
    public JLabel newbieLabel;
    
    public HSRegistrantsTablePanel(ContestApplet ca, JFrame jf) {
        super(ca, "Who's registered", new UserTableModel(ca.getModel(), CommonData.hsRegistrantsHeader), true);
        this.jf = jf;
