...
public class RegistrantsTablePanel extends UserTablePanel {
    ...
    public RegistrantsTablePanel(ContestApplet ca, UIPage page, JFrame jf) {
        super(ca, page, new UserTableModel(ca.getModel(), CommonData.registrantsHeader), "registrants_user_renderer", "registrants_header_renderer");
        page.getComponent("registrants_table_menu_info").addEventListener("action", new UIActionListener() {
                public void actionPerformed(ActionEvent e) {
                    infoPopupEvent();
                }
            });
        this.jf = jf;
        totalLabel = page.getComponent("total_label");
        div1Label = page.getComponent("div1_label");
        div2Label = page.getComponent("div2_label");
        newbieLabel = page.getComponent("newbie_label");
        ...
        ////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if(totalLabel != null)
        {
            ...
            div1Label.setProperty("Text", "Div 1 [" + getDiv1Count() + "]");
            div2Label.setProperty("Text", "Div 2 [" + getDiv2Count() + "]");
    ...
    public int getDiv1Count()
    {
        ...
        {
            if( ((UserNameEntry) table.performAction("getValueAt", new Object[] {new Integer(i), new Integer(1)})).getRank() >= 1200 )
            {
                count++;
    ...
    public int getDiv2Count()
    {
        ...
        for(int i = 0; i < getRowCount(); i++ )
        {
            if( ((UserNameEntry) table.performAction("getValueAt", new Object[] {new Integer(i), new Integer(1)})).getRank() < 1200 && ((UserNameEntry) table.performAction("getValueAt", new Object[] {new Integer(i), new Integer(1)})).getRank() != 0 )
            {
                count++;
