...
import com.topcoder.client.contestApplet.frames.SourceViewer.SourceViewerListener;
 ...
 * @version $Id: LongCodeViewer.java 70600 2008-05-14 21:31:02Z dbelfer $
 */
        ...
        private final CoderComponent.Listener myCoderComponentListener = new CoderComponent.Listener() {
            public void coderComponentEvent(CoderComponent coderComponent) {
                if (coderComponent.hasSourceCode()) {
                    ...
                    currentComponent.removeListener(this);
                } else {
