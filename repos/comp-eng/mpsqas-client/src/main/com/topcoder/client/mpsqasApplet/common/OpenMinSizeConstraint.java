 ...
 * @author mitalub
 */
public class OpenMinSizeConstraint extends MinSizeConstraint {

    public OpenMinSizeConstraint(int dimension, String paramName) {
        super(-1, dimension, paramName);
    }

    public OpenMinSizeConstraint(int size, int dimension, String paramName) {
