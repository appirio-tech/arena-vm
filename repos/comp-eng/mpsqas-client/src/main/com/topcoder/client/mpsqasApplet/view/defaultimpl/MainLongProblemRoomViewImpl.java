...
/**
 * Default view implementation for Main Long Problem Room.
 *
 * @author mktong
 */
public class MainLongProblemRoomViewImpl extends JPanelView
        implements MainLongProblemRoomView {

    private static String[] FULL_PROBLEM_NAMES = {"Writer", "Modified", "Class", "Status"};
    private static String[] NO_WRITER_PROBLEM_NAMES =
            {"Modified", "Class", "Status"};
    private static String[] NO_STATUS_PROBLEM_NAMES =
            {"Writer", "Modified", "Class"};
    ...
    private MainLongProblemRoomController controller;
     ...
     */
    public void init() {
        controller = MainObjectFactory.getMainLongProblemRoomController();
    ...
    private Object[][] getTableData(ArrayList problems) {
        Object[][] data = new Object[problems.size()][4];
        ...
        for (int i = 0; i < problems.size(); i++) {
            ...
            data[i][3] = StatusConstants.getStatusName(info.getStatus());
        }
        return data;
    }
    ...
    private Object[][] getTableDataNoWriter(ArrayList problems) {
        Object[][] data = new Object[problems.size()][3];
        ProblemInformation info;
        for (int i = 0; i < problems.size(); i++) {
            info = (ProblemInformation) problems.get(i);
            data[i][0] = info.getLastModified();
            data[i][1] = info.getProblemComponents()[0].getClassName();
            data[i][2] = StatusConstants.getStatusName(info.getStatus());
        }
        return data;
    }
